...
validation_generator=datagen_train.flow_from_directory(r"C:\Users\jaswanth\OneDrive\Desktop\plant disease detection\dataset\train",target_size=(48,48), batch_size=batch_size,class_mode='categorical', shuffle=True)
#initialising CNN
model=Sequential()
#conv-1
